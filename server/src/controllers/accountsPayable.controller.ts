...
export class AccountsPayableController {
    ...
    // GET /api/accounts/payable/stats - Estatísticas
    ...
    // PUT /api/accounts/payable/:id - Atualizar conta a pagar
    ...
    // POST /api/accounts/payable/:id/pay - Registrar pagamento
    async pay(req: Request, res: Response) {
        try {
            const { id } = req.params;
            const data = payPayableSchema.parse(req.body);
    ...
    // DELETE /api/accounts/payable/:id - Cancelar conta a pagar
    async delete(req: Request, res: Response) {
        try {
            ...
            res.json({ message: 'Conta a pagar cancelada com sucesso' });
        } catch (error) {
            console.error(error);
